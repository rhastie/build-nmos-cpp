...
ENV APT_KEY_DONT_WARN_ON_DANGEROUS_USAGE=DontWarn \
    NMOS_CPP_VERSION=f5dce9d6ff6e4dc2b575dc634c1b28f39f6d41bd
...
## Get and Make CMake version 3.17.3 (latest when Dockerfile developed) - Adjust as necessary
...
RUN cd /home/ && git config --global http.sslVerify false && \
    git clone --branch release/1.25 https://github.com/conan-io/conan.git && \
